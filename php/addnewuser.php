<?php
  ...
  function errorMessages($error_index, $status_index) 
  {
    ...
    "Cihaz Bilgileri eklenirken hata oluştu", "Arıza Bilgileri eklenirken hata oluştu", "Ücret Bilgileri eklenirken hata oluştu");
    ...
    <section class="features" id="ourservices">
      ...
      <div class="container">
        ...
        <div class="section-heading text-center">
          <h2 class="darkclr" id="featurestitle">ARIZA EKLE</h2>
          <!-- Error Message -->
                ...
                <div class="card-body">
                  ...
                  <form method="POST" autocomplete="off">
                    ...
                    <div class="card-body">
                      <!-- Total Payment -->
                      <div class="form-group user-box mt-4 mb-3">
                        <input type="text" maxlength="10" name="payment_total" placeholder="Ücret" required/>
