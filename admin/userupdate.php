...
<?php
  ...
  function errorMessages($error_index, $status_index) 
  {
    ...
    "Kullanıcı Bilgileri eklenirken hata oluştu", "Kullanıcı Bilgileri güncellenirken hata oluştu",
    "Cihaz Bilgileri eklenirken hata oluştu", "Cihaz Bilgileri güncellenirken hata oluştu", 
    "Arıza Bilgileri eklenirken hata oluştu", "Arıza Bilgileri güncellenirken hata oluştu",
    "Ücret Bilgileri eklenirken hata oluştu", "Ücret Bilgileri güncellenirken hata oluştu");
        ...
        if($error_counter == 0)
        {
         ...
         if($error_counter == 0)
         {
            ...
            else
            {
              ...
              payment_total = ?,
              payment_status = ?
              WHERE payaccident_id = '$accident_id'");
          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Arıza Kaydını Güncelle</h6>
              </div>
              <!-- Header -->
              <!-- Body -->
              <div class="card-body">
