...
<html lang="tr">
  ...
  <body class="light" id="page-top">
   ...
   <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="../indexen.php">UZMAN GSM</a>
                ...
                <div class="col-lg-6">
                  <div class="p-5">
                    ...
                    <div class="text-center">
                      ...
                      <span class="text-muted">Device Tracker System</span>
                      <hr/><br/>
                    </div>
                    <!-- Header -->
                    <form action="<?php echo "user.php" ?>" method="POST" id="userform" autocomplete="off" class="user">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control form-control-user" maxlength="50" name="name" oninput="this.value = this.value.toUpperCase()" placeholder="Name" required/>
                      </div>
                      <!-- Name -->
                      <!-- Surname-->
                      <div class="form-group">
                        <input type="text" class="form-control form-control-user"  maxlength="50" name="surname" oninput="this.value = this.value.toUpperCase()" placeholder="Surname" required/>
                      </div>
                      <!-- Surname -->
                      <!-- Device Tracker Number -->
                      <div class="form-group">
                      <input type="text" class="form-control form-control-user" maxlength="10" name="user_password" oninput="this.value = this.value.toUpperCase()" placeholder="Tracking Number" required/>
                      </div>
                      <!-- Device Tracker Number -->
                      <br/>
                      <!-- Button -->
                      <button type="submit" class="btn btn-block mt-3 mb-3 text-light"  style="border-color:#FF3100; background-color: #FF3100;" value="Submit" name="userSubmit">VIEW</button>
